...
export default function CalendarPage() {
  ...
  return (
    <div>
      <Navbar />
      <main className="mx-auto lg:ml-64 max-w-6xl px-4 py-6"><div className="glass-card"><FullCalendar plugins={[dayGridPlugin, timeGridPlugin, interactionPlugin]} initialView="dayGridMonth" editable events={events} eventDrop={onDrop} height="75vh" /></div></main>
    </div>
  );
}
