    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="grid w-full max-w-5xl gap-6 md:grid-cols-2">
        <section className="glass-card hidden p-8 md:block">
          ...
          <h1 className="mt-3 text-4xl font-extrabold text-white">Create your team workspace.</h1>
          <p className="mt-4 text-slate-300">Plan projects, assign tasks, and track status across TODO, IN PROGRESS, and DONE.</p>
        </section>
