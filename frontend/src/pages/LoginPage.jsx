    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="grid w-full max-w-5xl gap-6 md:grid-cols-2">
        <section className="glass-card hidden p-8 md:block">
          ...
          <h1 className="mt-3 text-4xl font-extrabold text-slate-900">Move work forward beautifully.</h1>
          <p className="mt-4 text-slate-600">Real-time tasks, collaborative projects, and a fast dashboard designed for teams.</p>
        </section>
