...
## UI fixes included
- Better light-theme contrast (no white-on-white)
- Sidebar navigation on desktop and bottom-nav on mobile
- Kanban drag-drop status persistence with optimistic updates
- Profile page with avatar upload preview and account controls
